...
public abstract class CursorRecyclerViewAdapter<VH extends RecyclerView.ViewHolder> extends CursorAdapter {
    ...
    public CursorRecyclerViewAdapter(Context context, Cursor c, boolean autoRequery) {
